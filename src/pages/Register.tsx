      ...
      <div className="flex-grow flex items-center justify-center bg-gray-50 dark:bg-gray-900 py-12">
        <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-800 p-10 rounded-xl shadow-lg relative">
          ...
          <div className="text-center pt-6">
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">Join Electrify today</p>
          </div>
          ...
          <div className="flex flex-col gap-3 mt-4">
            ...
            >
              ...
              {oauthLoading === 'github' ? 'Signing up with GitHub...' : 'Sign up with GitHub'}
            </Button>
          </div>

          <div className="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
            Already have an account?{" "}
            <Link to="/login" className="text-electrify-600 hover:text-electrify-500">
              Sign in
            </Link>
          </div>
        </div>
